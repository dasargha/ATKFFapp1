 ...
 */
public class MatchStandingsAdapter extends BaseAdapter {
    private Activity mActivity;

    public MatchStandingsAdapter(Activity mActivityMain) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.match_standing_item, parent, false);
