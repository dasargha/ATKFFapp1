 ...
 */
public class AboutCTAdapter extends BaseAdapter {
    private Activity mActivity;

    public AboutCTAdapter(Activity mActivityMain) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.about_atkff_ct_intentitem, parent, false);
