 ...
 */
public class AboutFTAdapter extends BaseAdapter {
    private Activity mActivity;

    public AboutFTAdapter(Activity mActivityMain) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.aboutatkff_ft_intent_item, parent, false);
