...
public class StoriesIndianfootballAdapter extends BaseAdapter {
    private Activity mActivity;

    public StoriesIndianfootballAdapter(Activity mActivityMain) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.stories_indianfootballitem, parent, false);

            // well set up the ViewHolder
            viewHolder = new ViewHolderItem();
            viewHolder.story_pic = (ImageView) convertView.findViewById(R.id.story_indianfootball);
